...
const Education = ({ education }) => {
  ...
  const active = activeIdx != null ? education[activeIdx] : null;

  return (
    <section id="education" className="experiences-section">
        ...
        <ol className="relative mr-4 ml-4">
          {education.map((edu, i) => {
            ...
            const isPresent =
              ...
              (edu.date || "").toLowerCase().includes("current");
          ...
          >
            ...
            >
              ...
              <div className="p-4 sm:p-6 border-b border-gray-100 dark:border-gray-800">
                <div className="flex items-start gap-3">
                  <img
                    src={`${process.env.PUBLIC_URL}/${String(active.institution_logo || "").replace(/^\/+/, "")}`}
                    alt={active.institution_name}
